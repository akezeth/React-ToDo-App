...
- A component that adds and removes tasks
- A component that clears tasks from the list
...
git clone https://github.com/akezeth/React-ToDo-App.git
```
...
Feel free to check the [issues page](https://github.com/akezeth/React-ToDo-App/issues).
...
This project is licensed under the [MIT License](https://github.com/akezeth/React-ToDo-App/blob/main/LICENSE).
